...
const initState = {
  count: 3,
  diaryList: [
    { id: 0, writer: "이미지", contents: "오늘 할일 정리해서 기록하기", emotion: 5, date: new Date().getTime() },
    { id: 1, writer: "김은희", contents: "텀블러 세척 후 커피 받아 놓기 , 물 떠놓기", emotion: 3, date: new Date().getTime() },
    { id: 2, writer: "이정진", contents: "오늘의 뉴스 시청하기 / 회의 안건 기록해 놓기", emotion: 2, date: new Date().getTime() },
    { id: 3, writer: "박해인", contents: "전일 매출 기록 분석하기, 전월 매출 평균 기록하기", emotion: 4, date: new Date().getTime() },
  ],
};
